...
export default function Order() {
  ...
  return (
    <ProfileContentContainer title="View Orders">
      <div className="innerDivBackgroundColour border border-white/[.5] pb-4 rounded-md shadow-lg shadow-black min-h-[420px] flex flex-col justify-between min-w-full">
        <table className="text-white min-w-full table-fixed">
        ...
        <div className="flex justify-center items-center mt-4 gap-4">
          <button
            ...
            className="px-4 py-2 border text-white rounded hover:bg-white disabled:opacity-50"
          >
            Previous
          </button>
